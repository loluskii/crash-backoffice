    ...
    <div>
       <form id="single-stop" @submit.prevent="getResults(1)">
            ...
            <div class="row m-t-10">
                ...
                <br class="d-sm-none">
                <div class="col-sm-3">
                    <select name="class" id="class-type" class="form-control" v-model="filterData.sport">
                        <option value="">Sport</option>
                    </select>
                </div>
                <br class="d-sm-none">
                <div class="col-sm-3">
                    <select name="class" id="class-type" class="form-control" v-model="filterData.league">
                        <option value="">League</option>
                    </select>
                </div>
                <br class="d-sm-none">
                <div class="col-sm-3">
                    <select name="class" id="class-type" class="form-control" v-model="filterData.market">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getResults(page){
                this.loading = true
                Player.getPlayerGamingActivity(this.id, this.filterData, page).then(res=>{
                    this.loading = false;
