                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr v-if="summary != '' && !loading">
                            ...
                            <td>{{ formatNumber(summary.returns) }}</td>
                            <td>{{ formatNumber(summary.returns) }}</td>
                            <td>N0.00</td>
                            <td>0%</td>
                        </tr>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr v-for="(result, index) in results" v-if="results.length > 0 && !loading" :key="index">
                            ...
                            <td>{{ formatNumber(result.returns) }}</td>
                            <td>{{ formatNumber(result.returns) }}</td>
                            <td>N0.00</td>
                            <td>0%</td>
                        </tr>
...
import Reports from '../../services/reports'
    ...
    export default {
        ...
        methods:{
            ...
            getResults(){
                this.loading = true
                Reports.getTaxOnReturn(this.filterData).then(res=>{
                    this.loading = false;
        ...
        asyncData ({ store }) {
            store.dispatch('setTitle', 'Tax On Return Report')
        },
        mounted(){
