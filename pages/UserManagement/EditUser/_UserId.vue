    ...
    <form @submit.prevent="validateBeforeSubmit">
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="form-group row">
            <div class="col-sm-4 text-right txt_media">
              <label class="form-control-label" for="country"> State </label>
            </div>
            <div class="col-sm-8">
              <select
                name="country"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input
                ...
                :class="{
                  input: true,
                  'is-danger': errors.has('confirm_email'),
                }"
                type="email"
                placeholder=""
                data-vv-as="email"
              />
              <i
                v-show="errors.has('confirm_email')"
                class="fa fa-warning text-danger"
              ></i>
              <span
                v-show="errors.has('confirm_email')"
                class="help is-danger text-danger"
                >{{ errors.first("confirm_email") }}</span
              >
            </div>
          </div>
          <div class="form-group row">
    ...
    validateBeforeSubmit() {
      this.$validator.validateAll().then((result) => {
        if (result) {
          ...
          this.$axios
            .post("/admin/settings/users/update", this.data)
            .then((res) => {
