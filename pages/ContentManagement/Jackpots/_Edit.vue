...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            if(id){
                CMS.getJackpot(id).then(res => {
                    this.formData.title = res.title
                    this.formData.amount = res.amount
                    this.formData.stake = res.stake
                    this.formData.agent_commission = res.agent_commission
                    this.formData.fixtures = res.matches
                    this.formData.terms = res.terms
                    this.formData.id = id;
        ...
        asyncData ({ store }) {
            store.dispatch('setTitle', 'Jackpot')
        },
    }
</script>
